...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">ĐẶT DỊCH VỤ ({{ $order->pitch->name }})</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-2 mb-3">
            <div class="card" style="width: auto;">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.order-services.store', $order) }}" method="post">
                        @csrf
                        ...
                        <div class="row mb-2">
                            ...
                            <input name="quantity" class="col-6" min="1" max="{{  $service->inventory }}" type="number" value="0">
                        </div>
