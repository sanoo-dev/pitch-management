...
class RoleController extends Controller
{
    ...
    {
        $this->middleware('permission:Xem vai trò|Thêm vai trò|Sửa vai trò|Xoá vai trò', ['only' => ['index','store']]);
        $this->middleware('permission:Thêm vai trò', ['only' => ['create','store']]);
        $this->middleware('permission:Sửa vai trò', ['only' => ['edit','update']]);
        $this->middleware('permission:Xoá vai trò', ['only' => ['destroy']]);
    }
